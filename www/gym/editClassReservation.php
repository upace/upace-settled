			...
			<div class="jarviswidget" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<input type="hidden" name="occupId" id="occupId" value="<?php echo $_GET['rid'];?>" />
							<header>
								Edit Reservation
							</header>
                                    <fieldset>
							...
							<fieldset>
                                        <section class="col col-6">
                                            <label class="select">
                                                <select name="classes" id="classes" onchange="get_class_slot_list(this.value)">
...
<!-- end widget grid -->
		...
		$(document).ready(function() {
			...
			//--------- Get University user list
                        ...
                        edit_classReservation('<?php echo $_REQUEST['rid']; ?>');
