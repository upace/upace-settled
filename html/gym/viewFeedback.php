										...
										<table id="datatable_tabletools" class="table table-striped table-bordered table-hover universities" width="100%">
											<thead>
												<tr>
													...
													<th data-class="expand">Start Time</th>
													<th data-class="expand">Post Date</th>
													<th data-class="expand">Rating</th>
													<th data-class="expand">Comment</th>
													<th data-class="expand" class="feedback_username">User Name</th>
												</tr>
											</thead>
											<tbody>
...
<!--												<tr>
		...
		<script type="text/javascript">
                           getStaffFeedback("<?php echo $_GET['lid']?>");       
		</script>
